...
dseg    segment para public 'data'
	...
	string	db	"Teste prático de T.I",0
		cCar		db	32	; Guarda um caracter do Ecran 
		cCor		db	7	; Guarda os atributos de cor do caracter
		cCar2		db	32	; Guarda um caracter do Ecran 
		cCor2		db	7	; Guarda os atributos de cor do caracter
