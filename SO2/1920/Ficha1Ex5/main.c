...
int main(int argc, LPSTR argv[])
{
	...
	wprintf(L"Escolhe um programa a executar: ");
	wchar_t new_proc[256];
	_getws_s(new_proc, 256);
	...
	if(!CreateProcess(new_proc, argv[1], NULL, NULL, FALSE, 0, NULL, NULL, &si, &pi))
	{
