...
Consola::Consola()
{
    ...
    // e já ninguêm usa esses "sistemas"
}
*/
...
//   e muda para essa fonte (ou seja, muda também a fonte)
...
void Consola::setTextSizeXP(int x, int y){
#ifdef _MSC_VER
    // Obtém acesso ás funções "secretas" do Windows
    ...
    for (size_t i = 0; i < NumFonts; ++i)
    {
        ...
        // isto é mesmo força bruta, mas no XP, é o que há (já ninguêm usa isso)
