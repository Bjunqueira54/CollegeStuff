...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/monster_slayer_c___ncurses

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/monster_slayer_c___ncurses: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/monster_slayer_c___ncurses ${OBJECTFILES} ${LDLIBSOPTIONS} -lncurses
