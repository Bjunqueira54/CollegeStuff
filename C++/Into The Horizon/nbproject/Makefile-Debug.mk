...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/into_the_horizon.exe

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/into_the_horizon.exe: ${OBJECTFILES}
...
${OBJECTDIR}/Galeon.o: Galeon.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Galeon.o Galeon.cpp
...
${OBJECTDIR}/Ocean.o: Ocean.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Ocean.o Ocean.cpp
...
${OBJECTDIR}/Special.o: Special.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Special.o Special.cpp
