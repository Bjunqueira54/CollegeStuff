    ...
    public static void main(String[] args) throws InterruptedException
    {
        ...
        try{                        
            ...
            for(i=0; i<nWorkers; i++){
                output = /***/ //Cria um ObjectOutputStream associado ao socket relativo ao worker com indice i
            ...
            for(i=0; i<nWorkers; i++){
                input = /***/ //Cria um ObjectInputStream associado ao socket relativo ao worker com indice i
